module divider(
    ...
    nor (err_en, count[1], count[0]); 
    
    dff d_err0(.D(sub[0]), .clk(clk), .rst(rst), .en(err_en), .q(sub_reg[0]));
    dff d_err1(.D(sub[1]), .clk(clk), .rst(rst), .en(err_en), .q(sub_reg[1]));
    dff d_err2(.D(sub[2]), .clk(clk), .rst(rst), .en(err_en), .q(sub_reg[2]));
    dff d_err3(.D(sub[3]), .clk(clk), .rst(rst), .en(err_en), .q(sub_reg[3]));
    dff d_err4(.D(sub[4]), .clk(clk), .rst(rst), .en(err_en), .q(sub_reg[4]));
    dff d_err5(.D(sub[5]), .clk(clk), .rst(rst), .en(err_en), .q(sub_reg[5]));
    dff d_err6(.D(sub[6]), .clk(clk), .rst(rst), .en(err_en), .q(sub_reg[6]));
    dff d_err7(.D(sub[7]), .clk(clk), .rst(rst), .en(err_en), .q(sub_reg[7]));
    ...
    and (reg_en, not_count1, count[0]);

    dff d_reg0(.D(pr[0]), .clk(clk), .rst(rst), .en(reg_en), .q(X1_reg[0]));
    dff d_reg1(.D(pr[1]), .clk(clk), .rst(rst), .en(reg_en), .q(X1_reg[1]));
    dff d_reg2(.D(pr[2]), .clk(clk), .rst(rst), .en(reg_en), .q(X1_reg[2]));
    dff d_reg3(.D(pr[3]), .clk(clk), .rst(rst), .en(reg_en), .q(X1_reg[3]));
    dff d_reg4(.D(pr[4]), .clk(clk), .rst(rst), .en(reg_en), .q(X1_reg[4]));
    dff d_reg5(.D(pr[5]), .clk(clk), .rst(rst), .en(reg_en), .q(X1_reg[5]));
    dff d_reg6(.D(pr[6]), .clk(clk), .rst(rst), .en(reg_en), .q(X1_reg[6]));
    dff d_reg7(.D(pr[7]), .clk(clk), .rst(rst), .en(reg_en), .q(X1_reg[7]));
